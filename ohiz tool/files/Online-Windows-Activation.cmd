...
title Online Windows  Activation Script v6.0
...
echo.                     
Echo.                                                                             
echo [38;2;255;255;0m     [1] Activate Windows and Office                         
echo [38;2;255;255;0m                                                          
echo [38;2;255;255;0m     [2] Check Windows and Office Activation Status                   
echo [38;2;255;255;0m                                                           
echo [38;2;255;255;0m     [3] Extract $OEM$ Folder To Desktop                     
echo [38;2;255;255;0m                                           
echo [38;2;255;255;0m     [4] Exit                                                                                         
ECHO.            
choice /C:1234 /N /M ".                   Enter Your Choice :..... "
if errorlevel 4 goto:Exit
if errorlevel 3 goto:Extract$OEM$
...
@Echo off
schtasks /delete /tn Online_windows_Activation_Script-Renewal /f 1>nul 2>nul
schtasks /delete /tn Online_windows_Activation_Script-Run_Once /f 1>nul 2>nul
@RD /s /q "%windir%\Online_windows_Activation_Script" >nul 2>&1
md "%windir%\Online_windows_Activation_Script"
...
copy /y "%temp%\temp_echo_file" + "%temp%\temp_cmd_file" "C:\Windows\Online_windows_Activation_Script\Online_windows_Activation_Script-Renewal.cmd" >nul
echo @echo off^&set "Run_Once=1">"%temp%\temp_echo_file"
copy /y "%temp%\temp_echo_file" + "%temp%\temp_cmd_file" "C:\Windows\Online_windows_Activation_Script\Online_windows_Activation_Script-Run_Once.cmd" >nul
del /q "%temp%\temp_cmd_file" >nul & del /q "%temp%\temp_echo_file" >nul

call :create_file  %0 "%temp%\Online_windows_Activation_Script-Renewal.xml" "REM (Re)activate xml Start" "REM (Re)activate xml End"

call :create_file  %0 "%temp%\Online_windows_Activation_Script-Run_Once.xml" "REM Run_Once xml Start" "REM Run_Once xml End"

call :create_file  %0 "C:\Windows\Online_windows_Activation_Script\Info.txt" "REM Info Start" "REM Info End"
...
set Online=1
set windows_IP=172.16.0.2
set windows_Port=1688
If defined Renewal_Task call :Re_Activate>>"%windir%\Online_windows_Activation_Script\logfile.txt"&exit
If defined Run_Once call :Re_Activate>>"%windir%\Online_windows_Activation_Script\logfile.txt"&exit
:Re_Activate
echo ==============================================
...
setlocal EnableExtensions EnableDelayedExpansion
set "servers="
set "servers=%servers% windows.digiboy.i"
set "servers=%servers%r"
set "servers=%servers% windows.mrxn.n"
set "servers=%servers%et"
set "servers=%servers% windows8.MSGuides.c"
set "servers=%servers%om"
set "servers=%servers% windows9.MSGuides.c"
set "servers=%servers%om"
set "servers=%servers% windows.chinancce.c"
set "servers=%servers%om"
set "servers=%servers% windows.library.h"
set "servers=%servers%k"
set "servers=%servers% windows.03k.o"
...
if %server_num% gtr !max_servers! (
	if defined Renewal_Task (echo No windows server available. Exiting...&exit 1651565635 rem Dummy Numbers To Show Error In Task)
	if defined Run_Once (echo No windows server available. Exiting...&exit 1651565635 rem Dummy Numbers To Show Error In Task)
	echo No windows server available, Press any key to Continue & pause>nul & goto:EOF)
	
set windows_IP=!server[%server_num%]!
echo. &echo Trying with windows server %windows_IP% &echo.
...
if defined Run_Once (schtasks /delete /tn Online_windows_Activation_Script-Run_Once /f 1>nul 2>nul &del /f /q %windir%\Online_windows_Activation_Script\Online_windows_Activation_Script-Run_Once.cmd >nul 2>&1 &echo Exiting...&exit)
Echo.
echo Press any key to Continue.
pause>nul
Goto:EOF
...
if "%key%" EQU "" (echo Could not find matching windows Client key&exit /b)
...
<Task version="1.3" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  <RegistrationInfo>
    ...
    <Version>1.0</Version>
    <Description>Online_windows_Activation_Script-Renewal - Weekly Activation Renewal Task</Description>
    <URI>\Online_windows_Activation_Script-Renewal</URI>
  ...
  <Actions Context="LocalSystem">
    <Exec>
      <Command>%windir%\Online_windows_Activation_Script\Online_windows_Activation_Script-Renewal.cmd</Command>
    </Exec>
  </Actions>
</Task>
...
<Task version="1.3" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  <RegistrationInfo>
    ...
    <Author>rpo/WindowsAddict</Author>
    <Version>1.0</Version>
    <Description>Online_windows_Activation_Script-Run_Once - Run and Delete itself on first Internet Contact</Description>
    <URI>\Online_windows_Activation_Script-Run_Once</URI>
    <SecurityDescriptor>D:P(A;;FA;;;SY)(A;;FA;;;BA)(A;;FRFX;;;LS)(A;;FRFW;;;S-1-5-80-123231216-2592883651-3715271367-3753151631-4175906628)(A;;FR;;;S-1-5-4)</SecurityDescriptor>
  </RegistrationInfo>
  <Triggers>
    <LogonTrigger>
  ...
  <Actions Context="LocalSystem">
    <Exec>
      <Command>%windir%\Online_windows_Activation_Script\Online_windows_Activation_Script-Run_Once.cmd</Command>
    </Exec>
  </Actions>
</Task>
...
Go to this Script Homepage https://www.nsaneforums.com/topic/318518-online-windows-activation-script/

Enjoy a most lightweight and 100% clean Windows and Office Activation.
REM Info End
::
:SetupCompleteFinal
schtasks /create /tn "Online_windows_Activation_Script-Renewal" /ru "SYSTEM" /xml "%TEMP%\Online_windows_Activation_Script-Renewal.xml" >nul 2>&1
schtasks /create /tn "Online_windows_Activation_Script-Run_Once" /ru "SYSTEM" /xml "%TEMP%\Online_windows_Activation_Script-Run_Once.xml" >nul 2>&1
del /f /q "%TEMP%\Online_windows_Activation_Script-Renewal.xml" >nul 2>&1)
del /f /q "%TEMP%\Online_windows_Activation_Script-Run_Once.xml" >nul 2>&1)
@RD /S /Q "%windir%\setup\"
exit
